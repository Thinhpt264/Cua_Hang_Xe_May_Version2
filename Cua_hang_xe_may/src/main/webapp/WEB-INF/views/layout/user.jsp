...
<a href="${pageContext.request.contextPath }/motobike" class="nav-item nav-link"><%= messages.getString("xe_may") %></a>
                            <div class="nav-item dropdown">
                        	    ...
                        	    <c:if test="${sessionScope.account != null }">
                        	       ...
                        	       <a href="${pageContext.request.contextPath }/appointcard"  class="dropdown-item"><i style="font-size: 120%" class="fa-solid fa-sheet-plastic"></i> <%=messages.getString("don_hen") %></a> 
